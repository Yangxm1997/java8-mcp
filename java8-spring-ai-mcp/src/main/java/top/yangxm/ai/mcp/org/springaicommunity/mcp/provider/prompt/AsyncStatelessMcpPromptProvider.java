...
import top.yangxm.ai.mcp.org.springaicommunity.mcp.method.prompt.AsyncStatelessMcpPromptMethodCallback;
...
public class AsyncStatelessMcpPromptProvider extends AbstractMcpPromptProvider {
    private static final Logger logger = LoggerFactoryHolder.getLogger(AsyncStatelessMcpPromptProvider.class);
