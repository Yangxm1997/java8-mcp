...
import top.yangxm.ai.mcp.org.springaicommunity.mcp.method.resource.SyncStatelessMcpResourceMethodCallback;
...
public class SyncStatelessMcpResourceProvider extends AbstractMcpResourceProvider {
    private static final Logger logger = LoggerFactoryHolder.getLogger(SyncStatelessMcpResourceProvider.class);
        ...
        List<SyncResourceSpec> resourceSpecs = this.resourceObjects.stream()
                .map(resourceObject -> Stream.of(this.doGetClassMethods(resourceObject))
                        ...
                        .map(mcpResourceMethod -> {
                            ...
                            SyncStatelessMcpResourceMethodCallback methodCallback = SyncStatelessMcpResourceMethodCallback.builder()
