...
import top.yangxm.ai.mcp.org.springaicommunity.mcp.method.complete.SyncStatelessMcpCompleteMethodCallback;
...
public class SyncStatelessMcpCompleteProvider extends AbstractMcpCompleteProvider {
    private static final Logger logger = LoggerFactoryHolder.getLogger(SyncStatelessMcpCompleteProvider.class);
        ...
        List<SyncCompletionSpec> completeSpecs = this.completeObjects.stream()
                .map(completeObject -> Stream.of(doGetClassMethods(completeObject))
                        ...
                        .map(mcpCompleteMethod -> {
                            ...
                            SyncStatelessMcpCompleteMethodCallback methodCallback = SyncStatelessMcpCompleteMethodCallback.builder()
