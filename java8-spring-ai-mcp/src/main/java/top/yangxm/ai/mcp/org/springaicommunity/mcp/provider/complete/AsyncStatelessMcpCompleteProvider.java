...
import top.yangxm.ai.mcp.org.springaicommunity.mcp.method.complete.AsyncStatelessMcpCompleteMethodCallback;
...
public class AsyncStatelessMcpCompleteProvider extends AbstractMcpCompleteProvider {
    private static final Logger logger = LoggerFactoryHolder.getLogger(AsyncStatelessMcpCompleteProvider.class);
        ...
        List<AsyncCompletionSpec> completeSpecs = this.completeObjects.stream()
                .map(completeObject -> Stream.of(doGetClassMethods(completeObject))
                        ...
                        .map(mcpCompleteMethod -> {
                            ...
                            AsyncStatelessMcpCompleteMethodCallback methodCallback = AsyncStatelessMcpCompleteMethodCallback.builder()
